<%@ Page Title="" Language="C#" MasterPageFile="~/NormalUserNoUpdatePanel.master" AutoEventWireup="true" CodeFile="RegisterTaxEscalations.aspx.cs" Inherits="PrOoc_RegisterTaxEscalations" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <ContentTemplate>
                                <table class="inc-details">
                                    ...
                                    <tr>
                                        <td class="inc-details-label">Entity:
                                        </td>
                                        <td style="padding-left: 4px;">
                                               <asp:TextBox runat="server" ID="Entity" Width="300px" MaxLength="255"> </asp:TextBox>
                                   
                                           <%-- <asp:DropDownList runat="server" ID="Entity" Width="300px" OnSelectedIndexChanged="Entity_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>--%>
                                        </td>
                                    </tr>
                                <%--    <tr>
                                        <td id="tdGovernmentEntity" runat="server" visible="False">Government Entities:
                                        </td>
                                        <td>
                                            <asp:DropDownList runat="server" ID="GovernmentEntity" Width="300px" Visible="False"></asp:DropDownList></td>
                                    </tr>
                                    <tr >
                                        <td ID="lblStatekHolder" runat="server" >
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="StakeHolder" Width="300px" MaxLength="50"></asp:TextBox></td>
                                    </tr>--%>
                                     <tr>
                                        <td class="inc-details-label">TaxType:
                                        </td>
                                        <td style="padding-left: 4px;">
                                            <asp:DropDownList runat="server" ID="TaxType" Width="300px"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="inc-details-label">Document Origin:
                                        </td>
                                        <td style="padding-left: 4px;">
                                            <asp:DropDownList runat="server" ID="DocumentOrigin" Width="300px"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="inc-details-label">Preferred Contact:
                                        </td>
                                        <td style="padding-left: 4px;">
                                            <asp:DropDownList runat="server" ID="PreferredContact" Width="300px"></asp:DropDownList>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td class="inc-details-label">Preferred Contact Details:
                                        </td>
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox runat="server" ID="PreferredContactDetails" Width="300px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="inc-details-label">Deadline Date:
                                        </td>
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox type="text" runat="server" ID="DatelineDate" Width="150px" />

                                            <asp:CalendarExtender ID="CalendarExtender2" runat="server" ClearTime="True"
                                                Enabled="True" Format="yyyy-MM-dd" TargetControlID="DatelineDate"
                                                TodaysDateFormat="yyyy-MM-dd">
                                            </asp:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="inc-details-label">Channel:
                                        </td>
                                        <td style="padding-left: 4px;">
                                            <asp:DropDownList runat="server" ID="TypeOfCorrespondence" Width="300px"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="inc-details-label">Executive Office Reference Number:
                                        </td>
                                        <td style="padding-left: 4px;">
                                            <asp:TextBox runat="server" ID="ExecutiveOfficeReferenceNumber" Width="300px" MaxLength="50"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 4px;">
                                             ...
                                             <asp:TextBox runat="server" ID="AuthorName" Width="300px" MaxLength="50"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
