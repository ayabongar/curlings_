...
<%@ Register Src="~/SurveyWizard/MatrixQuestion.ascx" TagName="MatrixQuestion" TagPrefix="uc1" %>
<%@ Register Src="~/SurveyWizard/HierarchicalLookup.ascx" TagName="HierarchicalLookup" TagPrefix="uc1" %>
            ...
            <table width="100%" class="tbl-question">
                <tr>
                    ...
                    <td class="ques-choices">
                        ...
                        <asp:CalendarExtender ID="txtDate_CalendarExtender" runat="server" Format="yyyy-MM-dd hh:mm" 
