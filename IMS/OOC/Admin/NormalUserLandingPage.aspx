<%@ Page Title="" Language="C#" MasterPageFile="~/OOC/NormalUser.master" AutoEventWireup="true" CodeFile="NormalUserLandingPage.aspx.cs" Inherits="Admin_NormalUserLandingPage" %>
                                    ...
                                    <ContentTemplate>
                                            ...
                                            <tr>
                                                <td align="right"><b>Search By </b>
                                                    ...
                                                    <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" runat="server"
                                                        ...
                                                        WatermarkText="IncidentNo,Subject,StatusType, Assigned To"></asp:TextBoxWatermarkExtender>
                                                    <asp:Button Text="Search" ID="Button4" runat="server" OnClick="btnTeamSearch_Click" />
                                                       <asp:Button Text="Clear" ID="btnclear" runat="server" Width="5px" OnClick="btnClear_Click" />
                                                </td>
                                        ...
                                        <asp:GridView runat="server" ID="gvIncidents" CssClass="documents" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Timestamp" HeaderText="Date Registered" DataFormatString="{0:yyyy-MM-dd}" />
                                                <asp:BoundField DataField="CreatedBySID" HeaderText="Registered By" />
                                                <asp:BoundField DataField="AssignedToFullName" HeaderText="Assigned To" />
                                                <asp:BoundField DataField="IncidentStatus" HeaderText="Incident Status" />
                                    ...
                                    <ContentTemplate>
                                        <table style="width: 100%" border="0">
                                            <tr>
                                               ...
                                               <asp:Button Text="Clear" ID="Button1" runat="server" Width="5px" OnClick="btnClear_Click" />
                                                    </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 4px;">
                                                                ...
                                                                <asp:CalendarExtender
                                                                    ID="txtIncidentDueDate_CalendarExtender" runat="server" ClearTime="True"
                                                                    Format="yyyy-MM-dd hh:mm" TargetControlID="txtIncidentDueDate" TodaysDateFormat="yyyy-MM-dd hh:mm" BehaviorID="_content_txtIncidentDueDate_CalendarExtender"></asp:CalendarExtender>
