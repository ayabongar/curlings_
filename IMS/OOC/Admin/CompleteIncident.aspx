                                    ...
                                    <table class="inc-details">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left: 4px;">
                                                ...
                                                <asp:CalendarExtender ID="txtIncidentDueDate_CalendarExtender" runat="server" ClearTime="True" Format="yyyy-MM-dd hh:mm" TargetControlID="txtIncidentDueDate"
                                                    TodaysDateFormat="yyyy-MM-dd hh:mm" BehaviorID="_content_txtIncidentDueDate_CalendarExtender">
