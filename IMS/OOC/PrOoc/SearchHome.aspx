<%@ Page Title="INCIDENT SEARCH" Language="C#" MasterPageFile="~/NormalUser.master" AutoEventWireup="true" CodeFile="SearchHome.aspx.cs" Inherits="PrOoc_SearchHome" %>
                                ...
                                <table>
                                    <tr>
                                         <td runat="server" id="tdReAssign">
                                              <asp:Button ID="bntReAssign" runat="server" Text="View" Width="100px" CommandArgument='<%#Eval("IncidentID") %>' CommandName="bntReAssign" Height="30px"></asp:Button>
                                             </td>
                                    </tr>
                                </table>
