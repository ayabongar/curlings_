 ...
 function (a, b) {
     a("#ace-settings-btn").on(ace.click_event, function (b) {
      ...
      a(document).ready(function (e) {
          var comp = a("#ace-settings-navbar")
          ace.settingFunction.navbar_fixed(null, comp[0].checked)
      }),
     ...
     // Mzwakhe modified to check on document ready
       ...
       a(document).ready(function (e) {
          ...
          // debugger;
           ...
           $.ajax({
               type: "POST",
               url: location.origin + '/CMS/Default.aspx/btnSet_Menu',
           ...
           function OnSuccess(result) {
              // debugger;
               if (result) {
                   var data = JSON.parse(JSON.stringify(result.d));
                   var compactSideBar = data.CompactSideBar;
                   //$("#ace-settings-compact")[0].checked = compactSideBar;
                
                   var comp = a("#ace-settings-compact")
                   if (compactSideBar == "true") {
                       a("#ace-settings-compact").prop("checked", compactSideBar);
     ...
     a("#ace-settings-highlight").on("click", function () {
         ...
         if (!a("#sidebar").hasClass("h-sidebar")) {
             if (this.checked) a("#sidebar li").addClass("hover").filter(".open").removeClass("open1").find("> .submenu").css("display", "none");
             else {
     ...
     a(document).on("settings.ace", function (b, c, d, e, f) {
         ...
         navbar_fixed: function (b, c, d, e) {
             ...
             c ? a(b).addClass("navbar-fixed-top") : a(b).removeClass("navbar-fixed-top"), d && a(document).trigger("settings.ace", ["navbar_fixed", c, b, d])
         },
         ...
         main_container_fixed: function (b, c, d) {
             ...
             c ? (a(b).addClass("container"), a(f).addClass("container")) : (a(b).removeClass("container"), a(f).removeClass("container")), d && (0 != f.length), navigator.userAgent.match(/webkit/i) && (a("#sidebar").toggleClass("menu-min"), setTimeout(function () {
    ...
    function (a, b) {
        ...
        a("#skin-colorpicker").on("change", function () {
            function b(b) {
                ...
                c.removeClass(" skin-1 skin-2 skin-3"), c.addClass(b);
                ...
                if ("" == b) {
                    ...
                    c.addClass(""), a(".ace-nav > li.grey").addClass("red").find(".badge").addClass("badge-yellow");
                    var e = 0;
                    a(".sidebar-shortcuts .btn").each(function () {
            ...
            var val = a("#SystemSkin")//a("#skin-colorpicker");
            val[0].innerText = c;

            var compactSideBar = $("#ace-settings-compact")[0].checked;
            var ace_Settings_Hover = $("#ace-settings-hover")[0].checked;            
            // debugger;
             var params = { compactSideBar: compactSideBar, submenuOnhover: ace_Settings_Hover, skin: c };
            $.ajax({
                type: "POST",
        ...
        ,
          $(document).ready(function (e) {
              ...
              $.ajax({
                  ...
                  contentType: 'application/json; charset=utf-8',
                  //  data: JSON.stringify(params),
                  success: OnSkinSuccess,
                  error: OnFailure
              });

              function OnSkinSuccess(result) {
