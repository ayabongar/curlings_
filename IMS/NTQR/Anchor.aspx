<%@ Page Title="" Language="C#" MasterPageFile="~/CmsPages.master" AutoEventWireup="true" CodeFile="Anchor.aspx.cs" Inherits="NTQR_Anchor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        <div class="panel panel-primary">
            <div class="panel-heading">
                Add Or Update Anchor Name lookup
            </div>
                ...
                <div class="pageBody">
                    <table style="padding: 15px; width: 100%;">
                        <tr runat="server" >
                             <td>
                                <fieldset>
                                    <legend>Existing Anchors</legend>
                                 
                                    <asp:GridView ID="gvUsers" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        CssClass="documents" DataKeyNames="Id" EmptyDataText="NO Anchor YET"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Name" HeaderText="Anchor Name">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
