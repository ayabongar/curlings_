...
public static class IncidentTrackingManager
{
    ...
    public static long SaveProcess(long processId, string processName, bool isActive, string prefix, string fileSize, bool addCoverPage, bool reAllocateBackToCreator, bool canWorkOnOneCase)
    {
  ...
  sb.Append(" WHERE us.fk_UserId = " + userId  );
    ...
    public static int UpdateIncidentDetails(DateTime dueDate, string assignedTo, string incidentId, string summary)
    {
        var oParams = new DBParamCollection
                          {
                              {"@DueDate", dueDate},
