...
public partial class Admin_NormalUserLandingPage : IncidentTrackingPage
{
    ...
    private void BindGridView()
    {
        ...
        if (CurrentProc.CanWorkOnOneCase)
        {
            ...
            if (teamincidents != null && teamincidents.Any())
            {
                ...
                else if (!Convert.ToInt64(ProcessID).Equals(135) && !Convert.ToInt64(ProcessID).Equals(74))
                {
                    ...
                    var table = incident.FindAll(my => my.Summary.ToLower().Contains(txtTeamSearch.Text.ToLower())
                        || my.ReferenceNumber.ToLower().Contains(txtTeamSearch.Text.ToLower())
                            || my.IncidentStatus.ToLower().Contains(txtTeamSearch.Text.ToLower()));
                ...
                else if (Convert.ToInt64(ProcessID).Equals(135) || Convert.ToInt64(ProcessID).Equals(74))
                {
                    ...
                    //    || my.ReferenceNumber.ToLower().Contains(txtMyIncidents.Text.ToLower())
                    //        || my.IncidentStatus.ToLower().Contains(txtMyIncidents.Text.ToLower()));
                    grdTeamIncidents.Bind(incident);
                }
            }
            else
            {
    ...
    protected void RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (tdComplete != null)
        {
            ...
            if (IncidentStatus.Equals("Return to originator"))
            {
                tdComplete.Visible = false;
                tdReAssign.Visible = false;
                tdReOpen.Visible = true;
