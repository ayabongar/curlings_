<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ReAssign.aspx.cs" Inherits="Admin_ReAssign" %>
                ...
                <fieldset>
                    ...
                    <table style="width: 80%;">
                        <tr>
                            ...
                            <td align="center"><b>Incidents Statuses</b><br />
                                <asp:RadioButtonList runat="server" ID="radStatuses" AutoPostBack="True" OnSelectedIndexChanged="radStatuses_SelectedIndexChanged">
                ...
                <td style="max-height: 20px">
                    <table width="100%" border="0" class="panel-heading">
                        <tr>
                            ...
                            <td align="right">
                                <asp:ImageButton runat="server" ImageUrl="~/Images/Collapse.png" ID="btnClose" CausesValidation="false" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
