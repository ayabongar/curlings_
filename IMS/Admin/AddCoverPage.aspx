<%@ Page Title="" Language="C#" MasterPageFile="~/NormalUser.master" AutoEventWireup="true" CodeFile="AddCoverPage.aspx.cs" Inherits="Admin_AddCoverPage" %>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Button runat="server"  ID="btnAcknowledgement" Text="Acknoledgement Letter" CommandArgument='<%#Eval("IncidentID") %>' CommandName="btnAcknowledgement"/>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
