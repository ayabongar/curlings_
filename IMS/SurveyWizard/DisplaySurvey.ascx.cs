...
public partial class SurveyWizard_DisplaySurvey : IncidentTrackingControl
{
    ...
    protected void RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        var questionDisplay = e.Row.FindControl("QuestionDisplay1") as surveywizard_questiondisplay_ascx;
    ...
    private static void LoadMatrixValues(string incidentId, surveywizard_questiondisplay_ascx questionDisplay)
    {
    ...
    private static void LoadHierarchyValues(string incidentId, surveywizard_questiondisplay_ascx questionDisplay)
    {
        var oParams = new DBParamCollection
                          {
                              {"@FieldId", questionDisplay.FieldId},
            ...
            )
        {
            if (data.HasRows)
            {
                var hierarchicallookup = questionDisplay.ThisControl as surveywizard_hierarchicallookup_ascx;
    ...
    private static void LoadADUserValues(string incidentId, surveywizard_questiondisplay_ascx questionDisplay)
    {
        var oParams = new DBParamCollection
                          {
                              {"@FieldId", questionDisplay.FieldId},
    ...
    private static void ChangeColor(Control c, int questinType, int scaleType, bool addColor)
    {
        switch (questinType)
        {
            ...
            case 9:
                {
                    var control = c as surveywizard_matrixquestion_ascx;
            ...
            case 20:
                {
                    var control = c as surveywizard_hierarchicallookup_ascx;
                    if (control != null)
                    {
    ...
    public bool SaveQuestions()
    {
        ...
        foreach (GridViewRow row in gvQuestions.Rows)
        {
            ...
            {
                var questionDisplay = row.FindControl("QuestionDisplay1") as surveywizard_questiondisplay_ascx;
                if (questionDisplay != null)
                {
    ...
    protected void ApplyDropdownSkipLogic()
    {
        foreach (GridViewRow row in gvQuestions.Rows)
        {
            ...
            {
                var dataKey = gvQuestions.DataKeys[row.RowIndex];
                var baby = row.FindControl("QuestionDisplay1") as ASP.surveywizard_questiondisplay_ascx;
