<%@ Page Title="" Language="C#" MasterPageFile="~/CmsPages.master" AutoEventWireup="true" CodeFile="Q3.aspx.cs" Inherits="NTQR_Q3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        <div class="panel panel-primary">
        <div class="panel-heading">Add Or Update Quarter 3 lookup by Objectives</div>
        <div class="pageBody">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db %>"
        DeleteCommand="DELETE FROM [NTQ_Lookup_Q3] WHERE [Id] = @original_Id"
        InsertCommand="INSERT INTO [NTQ_Lookup_Q3] ([fk_StrategicObjective_ID], [Name], [timestamp], [CreatedBy], [CreatedDate], [ModifiedBy], [ModifiedDate],[IsActive]) VALUES (@fk_StrategicObjective_ID, @Name, @timestamp, @CreatedBy, @CreatedDate, @ModifiedBy, @ModifiedDate,@IsActive)" OldValuesParameterFormatString="original_{0}"
        SelectCommand="SELECT * FROM [NTQ_Lookup_Q3]"
        UpdateCommand="UPDATE [NTQ_Lookup_Q3] SET [fk_StrategicObjective_ID] = @fk_StrategicObjective_ID, [Name] = @Name, [timestamp] = @timestamp, [CreatedBy] = @CreatedBy, [CreatedDate] = @CreatedDate, [ModifiedBy] = @ModifiedBy, [ModifiedDate] = @ModifiedDate,[IsActive]=@IsActive WHERE [Id] = @original_Id" >
        <DeleteParameters>
