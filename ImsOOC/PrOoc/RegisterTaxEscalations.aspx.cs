...
public partial class PrOoc_RegisterTaxEscalations : IncidentTrackingPage
{
    ...
    protected void Toolbar1_ButtonClicked(object sender, SCS.Web.UI.WebControls.ButtonEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case "Submit":
                {
                    ...
                    Response.Redirect(String.Format("~/PrOoc/RegisterTaxEscalations.aspx?procId={0}&incId={1}&type={2}",
                         CurrentIncidentDetails.ProcessId, CurrentIncidentDetails.IncidentID, "Escalation"));
            ...
            case "Print":
                {
                    var page = "~/PrOoc/RegisterTaxEscalations";
        ...
        if (CurrentIncidentDetails != null)
        {
            if (IncidentTrackingManager.AddWorkInfo(workInfo) > 0)
            {
                ...
                if (CurrentIncident == null)
                {
                    txtNotes.Clear();
                    Response.Redirect(
                        String.Format("~/PrOoc/RegisterTaxEscalations.aspx?procId={0}&incId={1}&type={2}",
                            CurrentIncidentDetails.ProcessId, CurrentIncidentDetails.IncidentID, "Escalation"));
                }
                else
                {
    ...
    private void SendFirstNotification(Incident cIncident)
    {
        try
        {
            ...
            var incidentURL = string.Format("http://{0}/ims/PrOoc/RegisterTaxEscalations.aspx?{1}",
