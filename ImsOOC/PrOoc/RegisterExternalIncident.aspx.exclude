<%@ Page Title="" Language="C#" MasterPageFile="~/NormalUserNoUpdatePanel.master" AutoEventWireup="true" CodeFile="RegisterExternalIncident.aspx.cs" Inherits="PrOoc_RegisterExternalIncident" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <ContentTemplate>
                                <table class="inc-details">
                                    ...
                                    <tr>
                                        <td class="inc-details-label">Type of Correspondence:
                                        </td>
                                        <td style="padding-left: 4px;">
