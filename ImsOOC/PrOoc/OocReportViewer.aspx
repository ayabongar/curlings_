<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OocReportViewer.aspx.cs" Inherits="PrOoc_OocReportViewer" %>
                    ...
                    <div class="panel-body">
                        <div class="pageBody" style="min-height: 600px">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnSubmit" Text="Submit" runat="server" OnClick="btnSubmit_Click" /><asp:Button ID="btnExport" Text="Export" runat="server" OnClick="btnExport_Click" /></td>
                                </tr>
                            </table>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:Panel ID="pnlgvReport" runat="server" Style="width: 1200px" ScrollBars="Both">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="padding-left: 4px;">
                                                                                                        ...
                                                                                                        <asp:CalendarExtender
                                                                                                            ...
                                                                                                            Format="yyyy-MM-dd hh:mm" TargetControlID="txtIncidentDueDate" TodaysDateFormat="yyyy-MM-dd hh:mm" BehaviorID="_content_CalendarExtender2"></asp:CalendarExtender>
                                            ...
                                            <asp:ModalPopupExtender ID="mpAllocate" runat="server" PopupControlID="pnlAllocate" TargetControlID="btnViewCase"
                                                Drag="True"
                                                CancelControlID="btnClose" BackgroundCssClass="modalBackground" BehaviorID="_content_mpAllocate" DynamicServicePath="">
