<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="ModifyHierarchyLookups.aspx.cs" Inherits="SystemAdmins_ModifyHierarchyLookups" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table cellpadding="0" width="100%">
                ...
                <fieldset>
                    <SCS:Toolbar ID="Toolbar1" runat="server" OnButtonClicked="ToolBarClicked"
                        ...
                        <Items>
                            ...
                            <SCS:ToolbarButton CausesValidation="True" CommandName="AddLookupItem" Text="Add Lookup Item" Visible="False" />
                            <SCS:ToolbarButton CausesValidation="True" CommandName="ViewLookupItems" Text="View Lookup Items" />
                            <SCS:ToolbarButton CausesValidation="True" CommandName="ViewLookupItems" Text="Modify Lookup Items" Visible="false" />
                            <SCS:ToolbarButton CausesValidation="True" CommandName="AddSecondLevel" Text="Relate" Visible="true" />
                        </Items>
            ...
            <td valign="top">
                <fieldset>
                    <asp:GridView ID="gvLookpus" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        EmptyDataText="THERE IS NO DATA AVAILABLE" PageSize="5">
                        <Columns>
                            ...
                            <asp:CheckBoxField DataField="IsActive" HeaderText="Active" SortExpression="IsActive">
                             ...
                             <asp:TemplateField HeaderText="Related">
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="chkRelated" Enabled="False" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Button runat="server" ID="btnDelete" Text="Delete" OnClick="DeleteLookUpData"/>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
        ...
        <tr runat="server" visible="false" id="row_view_items">
            <td colspan="2">
            <fieldset>
                    <asp:GridView DataKeyNames="LookupItemId" ID="gvItems" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="documents" OnRowDataBound="ItemsRowDataBound" onselectedindexchanged="ItemsSelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="ItemsPageChanging" PageSize="7">
                        <Columns>
                            <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Button   runat="server" ID="btnDelete" Text="Delete" OnClick="DeleteItem"/>
                                </ItemTemplate>
                            </asp:TemplateField>
