...
public partial class CreateNewProcess : System.Web.UI.Page
{
    ...
    protected void CreateProcess(object sender, EventArgs e)
    {
        ...
        var processId = IncidentTrackingManager.SaveProcess(0, processName, true, txtPrefix.Text.Trim(), Convert.ToString(Math.Floor(maFileSize)), ckAddCoverPage.Checked, chkCreater.Checked, ckCanShareIncidents.Checked,txtWorkingFolderUrl.Text);
