...
public partial class Admin_ListProcessInsidents : IncidentTrackingPage
{
            ...
            case "ViewDetails":
                {
                    if (gvIncidents.SelectedDataKey != null)
                    {
                        ...
                        {
                            Response.Redirect(String.Format("~/admin/IncidentRealOnly.aspx?procId={0}&incId={1}", prodessId, incidentId));
                        }
                    }
                    else
                    {
